...
public class ElasticSearchUtil {
     ...
     * @throws IOException
     */
    public static XContentBuilder getBuildMapping(String indexType) throws IOException {
        XContentBuilder mapping = XContentFactory.jsonBuilder().startObject()
                ...
                .startObject("text").field("type", "text")
                .endObject()
     ...
     * 设置Project的Mappings
     *
     * @param indexType 索引名称
     * @return
     * @throws IOException
     */
    public static XContentBuilder getProjectMapping(String indexType) throws IOException {
        XContentBuilder mapping = XContentFactory.jsonBuilder().startObject()
                .startObject(indexType)
                .startObject("properties")

                .startObject("projectId").field("type", "long")
                .endObject()

                .startObject("unitName").field("type", "text")
                .field("analyzer", "ik_max_word")
                .endObject()

                .startObject("unitId").field("type", "long")
                .endObject()

                .startObject("buildName").field("type", "text")
                .field("analyzer", "ik_max_word")
                .endObject()

                .startObject("buildId").field("type", "long")
                .endObject()

                .startObject("projectName").field("type", "text")
                .field("analyzer", "ik_max_word")
                .endObject()

                .startObject("planValue").field("type", "text")
                .endObject()

                .startObject("projectDate").field("type", "date")
                .endObject()
    ...
    public static XContentBuilder getUnitMapping(String indexType) throws IOException {
        XContentBuilder mapping = XContentFactory.jsonBuilder().startObject()
                .startObject(indexType)
                .startObject("properties")
                ...
                .startObject("unitParentId").field("type", "long")
                .endObject()
